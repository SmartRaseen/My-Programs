...
public class Solution
{
	...
	public static void BinaryWriteFile()
	{
		...
		using(BinaryWriter writter = new BinaryWriter(File.Open(@"C:\Users\USER\Desktop\sample1.txt",FileMode.Create)))
		{
			writter.Write(data);
	...
	{
		using(BinaryReader reader = new BinaryReader(File.Open(@"C:\Users\USER\Desktop\sample1.txt",FileMode.Open)))
		{
